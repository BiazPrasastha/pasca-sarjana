<div>
    <div class="mb-4">
        ...
        <a class="btn btn-secondary btn-label waves-effect waves-light"
            href="{{ route('admin.judiciaries.verification', ['document' => $file->Document->id]) }}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="container mt-5">
                ...
                <p>
                    Hasil dari Dokumen Tesis milikmu sudah kami periksa dan hasilnya <b>GAGAL</b>.
                    Silahkan melakukan revisi dokumen dan menyelesaikan semua persyaratan yang dibutuhkan agar dapat
