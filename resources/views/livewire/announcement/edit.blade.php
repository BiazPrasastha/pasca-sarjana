        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-body text-center">
                    <iframe class="card-img-top img-fluid"
                        src="@if ($file_changed) {{ $form?->file?->temporaryUrl() }}    @else  {{ asset("storage/$form?->file_placeholder") }} @endif"
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex">
                        <button class="btn btn-danger btn-label right ms-2" wire:click='destroy'>
                            <i class="ri-delete-bin-line label-icon align-middle fs-16 ms-2"></i>
                            Hapus
                        </button>
                        <button class="btn btn-primary btn-label right ms-2" wire:click='update'>
